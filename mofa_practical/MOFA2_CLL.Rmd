...
SUGGESTIONS:
- START FROM THE TRAIN MOFA OBJECT IF LESS THAN 2H WORKSHOP
- DON'T ACCESS SLOTS WITH @
...
dim(MOFAobject@expectations$Z[[1]])

# Dimensionality of the mRNA Weight matrix: 5000 features, 15 factors
dim(MOFAobject@expectations$W$Mutations)
```
