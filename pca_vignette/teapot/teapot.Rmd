...
setwd("/Users/ricard/Google Drive/Teaching/Data_integration_UPF_June2019/pca_vignette")
```

Load teapot data
```{r}
teapot <- read.csv("teapot.csv", header = TRUE)
```
...
How much variance each eigenvector captures (as a fraction of the total variance)?
```{r}
